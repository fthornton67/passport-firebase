...
var FirebaseStrategy = require('../lib/strategy');
...
describe('Strategy#userProfile', function() {
  ...
  describe('fetched from default endpoint', function() {
    ...
    strategy._oauth2.get = function(url, accessToken, callback) {
      if (url != 'https://graph.Firebase.com/v2.5/me') { return callback(new Error('incorrect url argument')); }
      if (accessToken != 'token') { return callback(new Error('incorrect token argument')); }
    
      var body = '{"id":"500308595","name":"Jared Hanson","first_name":"Jared","last_name":"Hanson","link":"http:\\/\\/www.Firebase.com\\/jaredhanson","username":"jaredhanson","gender":"male","email":"jaredhanson\\u0040example.com"}';
    ...
    it('should parse profile', function() {
      expect(profile.provider).to.equal('Firebase');
      ...
      expect(profile.profileUrl).to.equal('http://www.Firebase.com/jaredhanson');
  ...
  describe('fetched from default endpoint, with appsecret_proof', function() {
    ...
    strategy._oauth2.get = function(url, accessToken, callback) {
      if (url != 'https://graph.Firebase.com/v2.5/me?appsecret_proof=e941110e3d2bfe82621f0e3e1434730d7305d106c5f68c87165d0b27a4611a4a') { return callback(new Error('incorrect url argument')); }
      if (accessToken != 'token') { return callback(new Error('incorrect token argument')); }
  ...
  describe('fetched from default endpoint, with profile fields mapped from Portable Contacts schema', function() {
    ...
    strategy._oauth2.get = function(url, accessToken, callback) {
      if (url != 'https://graph.Firebase.com/v2.5/me?fields=id,username,name,last_name,first_name,middle_name,gender,link,email,picture') { return callback(new Error('incorrect url argument')); }
      if (accessToken != 'token') { return callback(new Error('incorrect token argument')); }
  ...
  describe('fetched from default endpoint, with profile fields mapped from Portable Contacts schema, with appsecret_proof', function() {
    ...
    strategy._oauth2.get = function(url, accessToken, callback) {
      if (url != 'https://graph.Firebase.com/v2.5/me?appsecret_proof=e941110e3d2bfe82621f0e3e1434730d7305d106c5f68c87165d0b27a4611a4a&fields=id,username,name,last_name,first_name,middle_name,gender,link,email,picture') { return callback(new Error('incorrect url argument')); }
      if (accessToken != 'token') { return callback(new Error('incorrect token argument')); }
  ...
  describe('fetched from default endpoint, with profile fields a mix of mapped from Portable Contacts schema and native Firebase properties', function() {
    var strategy = new FirebaseStrategy({
        clientID: 'ABC123',
        clientSecret: 'secret',
    ...
    strategy._oauth2.get = function(url, accessToken, callback) {
      if (url != 'https://graph.Firebase.com/v2.5/me?fields=id,username,name,last_name,first_name,middle_name,gender,link,email,picture,public_key,updated_time') { return callback(new Error('incorrect url argument')); }
      if (accessToken != 'token') { return callback(new Error('incorrect token argument')); }

      var body = '{"id":"500308595","name":"Jared Hanson","first_name":"Jared","last_name":"Hanson","link":"http:\\/\\/www.Firebase.com\\/jaredhanson","username":"jaredhanson","gender":"male","email":"jaredhanson\\u0040example.com", "updated_time": "2013-11-02T18:33:09+0000"}';
      callback(null, body, undefined);
    }
  ...
  describe('fetched from older version with fields specified in URL', function() {
    var strategy = new FirebaseStrategy({
        clientID: 'ABC123',
        clientSecret: 'secret',
        profileURL: 'https://graph.Firebase.com/v2.2/me?fields=id,username'
      }, function() {});
  
    strategy._oauth2.get = function(url, accessToken, callback) {
      if (url != 'https://graph.Firebase.com/v2.2/me?fields=id,username') { return callback(new Error('incorrect url argument')); }
      if (accessToken != 'token') { return callback(new Error('incorrect token argument')); }
  ...
  describe('fetched from older version with fields specified in URL, with appsecret_proof', function() {
    ...
    strategy._oauth2.get = function(url, accessToken, callback) {
      if (url != 'https://graph.Firebase.com/v2.2/me?fields=id,username&appsecret_proof=e941110e3d2bfe82621f0e3e1434730d7305d106c5f68c87165d0b27a4611a4a') { return callback(new Error('incorrect url argument')); }
      if (accessToken != 'token') { return callback(new Error('incorrect token argument')); }
  ...
  describe('error caused by invalid token', function() {
    ...
    it('should error', function() {
      ...
      expect(err.constructor.name).to.equal('FirebaseGraphAPIError');
